...
def main() -> None:
    ...
    parser.add_argument(
        "--base_cfg",
        type=str,
        default="/data/litengmo/HSMR/mia_custom/custom/stage2/checkpoints/lightweight_stage1_stage2/ood/emg2pose_ood_h8_20260519_103356/base_stage2_config.yaml",
    )
    ...
    if args.eval_only:
        if run_dir_arg:
            ...
            out_root = _latest_run_dir(out_root_parent, "emg2pose_ood_person_") or out_root_parent
        ...
        if run_dir_arg:
            ...
            out_root = out_root_parent / f"emg2pose_ood_person_{stamp}"
    ...
    _write_rows_csv(results_dir / "summary_ood_person_emg2pose.csv", rows)
    _write_summary_md(
        results_dir / "summary_ood_person_emg2pose.md",
        rows,
        title="Stage2 OOD People (EMG2Pose) Summary",
