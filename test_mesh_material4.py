...
# Color it with a gradient or solid
...
# Official material? No material in official code!
...
import cv2
cv2.imwrite("test_mesh_material4.png", cv2.cvtColor(color, cv2.COLOR_RGB2BGR))
